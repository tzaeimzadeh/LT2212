...
def preprocess_file():
    ...
    with gzip.open(os.path.join(args.inputfile, folder_path[0]), encoding='utf-8') as source_file:
        with gzip.open(os.path.join(args.inputfile, folder_path[1]), encoding='utf-8') as target_file:
        #gzip.open()
